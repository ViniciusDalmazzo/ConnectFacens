...
$sql = " SELECT DATE_FORMAT(t.data_inclusao, '%d %b %Y') AS data_inclusao, t.post, u.usuario,u.id,t.titulo FROM post AS t JOIN usuarios AS u ON (t.id_usuario = u.id) ORDER BY data_inclusao DESC";
